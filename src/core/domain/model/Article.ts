...
export type RawArticle = {
  ...
  content: string;
  tags: string[];
  estimatedReadingTimeMinutes: string | number;
  relatedTopicsTags: string[];
}
...
[{
  name: "Task",
  options: ["Write a cold email", "Write a blogpost", "Write 5 taglines", "Write a youtube video title", "Summarize in 3 paragraphs", "Translate from English to Spanish", "Create a tweet thread of 10 tweets"]
}, {
  name: "Topic"
}, {
  name: "Style",
  options: ["Academic", "Business", "Casual", "Creative", "Descriptive", "Emotional", "Expository", "Formal", "Informal", "Legal", "Medical", "Narrative", "Persuasive", "Poetic", "Technical"]
}, {
  name: "Tone",
  options: ["Angry", "Assertive", "Confident", "Cooperative", "Curious", "Empathetic", "Encouraging", "Enthusiastic", "Excited", "Friendly", "Funny", "Joyful", "Optimistic", "Professional", "Sad", "Serious", "Surprised", "Worried"]
}, {
  name: "Audience",
  options: ["5-year old", "10-year old", "Teenager", "20-year old", "30-year old", "40-year old", "50-year old", "60-year old", "70-year old", "", "Business audience", "Expert audience", "Hostile audience", "Neutral audience", "Uninformed audience", "", "My boss", "My teacher", "My parent", "My partner", "My child", "My colleague"]
}, {
  name: "Length",
  options: ["1 paragraph", "2 paragraphs", "3 paragraphs", "", "20 words", "50 words", "100 words", "200 words", "500 words"]
}, {
  name: "Format",
